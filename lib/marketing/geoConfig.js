export const GEO_CONFIG = {
  ...
  US: {
    ...
    locations: ["Austin, TX", "Seattle, WA", "Chicago, IL", "Denver, CO"]
  },
  GB: {
    code: "GB",
    name: "United Kingdom",
  ...
  SG: {
    ...
    locations: ["Singapore", "Jurong West", "Tampines", "Woodlands"]
  },
  ZA: {
    code: "ZA",
    name: "South Africa",
  ...
  AE: {
    ...
    locations: ["Dubai", "Abu Dhabi", "Sharjah", "Al Ain"]
  },
  PH: {
    code: "PH",
    name: "Philippines",
    ...
    locations: ["Manila", "Cebu City", "Davao", "Quezon City"]
  },
  ...
  INT: {
    ...
    locations: ["New York", "London", "Sydney", "Toronto"]
  }
};
