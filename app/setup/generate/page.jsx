          ...
          <div className="p-8">
               ...
               <div className="flex items-start gap-4">
                 ...
                 <div>
                   ...
                   <p className="text-sm text-slate-600 mt-1 max-w-2xl">
                     Generates images using local <strong>UI Forge (Stable Diffusion)</strong>.
                     Ensure <code>SD_API_URL</code> is reachable.
                   </p>
                 </div>
               </div>
             </div>
             ...
             <div className="grid gap-6 max-w-xl mx-auto">
               ...
               <div className="grid gap-4 mt-4">
                 ...
                 {/* New Error Help Box */}
                 {assetStatus === "error" && (
                    <div className="rounded-xl bg-rose-50 border border-rose-100 p-4 text-sm text-rose-800 animate-in slide-in-from-top-2">
                       <div className="font-bold flex items-center gap-2 mb-1">
                          <AlertTriangle className="w-4 h-4" /> Connection Failed
                       </div>
                       <p>To fix this:</p>
                       <ol className="list-decimal pl-5 mt-1 space-y-1">
                          <li>Open your Forge/A1111 folder terminal.</li>
                          <li>Run: <code className="bg-white px-1.5 py-0.5 rounded border border-rose-200 font-mono text-rose-600">./webui.bat --api --listen</code> (Windows)</li>
                          <li>Or: <code className="bg-white px-1.5 py-0.5 rounded border border-rose-200 font-mono text-rose-600">python launch.py --api --listen</code></li>
                          <li>Ensure the port matches the URL above.</li>
                       </ol>
                    </div>
                 )}
               </div>
