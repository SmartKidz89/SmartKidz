...
const LESSONS_PER_LEVEL = 50; // Reduced to 50 per level (approx 7200 total) to prevent browser timeout
    ...
    <PageMotion className="max-w-3xl mx-auto pb-20 pt-10">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-slate-600 font-medium">Create lesson data for import.</p>
        </div>
      </div>
      <Card className="p-8 space-y-8">
        <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200 text-sm text-slate-600">
          <p><strong>Step 1:</strong> Click Generate to build the CSV file.</p>
          <p><strong>Step 2:</strong> Click Download when ready.</p>
          <p><strong>Step 3:</strong> Upload to Supabase 'lessons' table.</p>
        </div>
